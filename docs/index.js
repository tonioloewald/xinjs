var Oo=Object.defineProperty;var Ne=(n,t)=>{for(var e in t)Oo(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var Jn={};Ne(Jn,{xinValue:()=>V,xinProxy:()=>Sn,xinPath:()=>Yn,xin:()=>P,version:()=>dt,vars:()=>r,varDefault:()=>c,updates:()=>zo,unobserve:()=>st,touchElement:()=>Ft,touch:()=>rn,throttle:()=>Wn,svgElements:()=>Ln,settings:()=>at,on:()=>rt,observe:()=>$n,mathML:()=>ca,makeComponent:()=>Rt,invertLuminance:()=>Lt,initVars:()=>bi,hotReload:()=>Jt,getListItem:()=>hn,elements:()=>g,debounce:()=>lt,darkMode:()=>yi,css:()=>Fn,boxedProxy:()=>un,boxed:()=>En,blueprintLoader:()=>Ci,blueprint:()=>ji,bindings:()=>K,bind:()=>X,StyleSheet:()=>Gn,MoreMath:()=>ii,Component:()=>y,Color:()=>v,BlueprintLoader:()=>Ut,Blueprint:()=>ht});var at={debug:!1,perf:!1};function sn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(sn);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=sn(a);else t[e]=a}return t}var ke="-xin-data",Cn=`.${ke}`,na="-xin-event",We=`.${na}`,U="xinPath",zn="xinValue",Bo="xinObserve",Do="xinBind",Vo="xinOn",Yn=(n)=>{return n&&n[U]||void 0};function V(n){return typeof n==="object"&&n!==null?n[zn]||n:n}var Hn=new WeakMap,ln=new WeakMap,Xn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=ln.get(n),a=Hn.get(n);if(e!=null)ln.set(t,sn(e));if(a!=null)Hn.set(t,sn(a))}for(let e of n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes)if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(Xn(e));else t.appendChild(e.cloneNode());return t},et=new WeakMap,hn=(n)=>{let t=document.body.parentElement;while(n.parentElement!=null&&n.parentElement!==t){let e=et.get(n);if(e!=null)return e;n=n.parentElement}return!1},qe=Symbol("observer should be removed"),ot=[],it=[],Vt=!1,zt,Ht;class ta{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw new Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw new Error("expect callback to be a path or function");ot.push(this)}}var zo=async()=>{if(zt===void 0)return;await zt},Ho=()=>{if(at.perf)console.time("xin async update");let n=Array.from(it);for(let t of n)ot.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw new Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===qe)return st(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===qe)st(e)});if(it.splice(0),Vt=!1,typeof Ht==="function")Ht();if(at.perf)console.timeEnd("xin async update")},rn=(n)=>{let t=typeof n==="string"?n:Yn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),new Error("touch was called on an invalid target");if(Vt===!1)zt=new Promise((e)=>{Ht=e}),Vt=setTimeout(Ho);if(it.find((e)=>t.startsWith(e))==null)it.push(t)},ea=(n,t)=>{return new ta(n,t)},st=(n)=>{let t=ot.indexOf(n);if(t>-1)ot.splice(t,1);else throw new Error("unobserve failed, listener not found")},Xo=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},aa=(...n)=>new Error(n.map(Xo).join(" ")),No=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Wo=0,qo=()=>(parseInt("10000",36)+ ++Wo).toString(36).slice(-5),Fo=()=>No()+qo(),Xt={},oa={};function ia(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var R=new WeakMap;function sa(n,t){if(R.get(n)===void 0)R.set(n,{});if(R.get(n)[t]===void 0)R.get(n)[t]={};let e=R.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a._auto_===void 0)a._auto_=Fo();e[a._auto_+""]=o});else n.forEach((a,o)=>{e[Nn(a,t)+""]=o});return e}function Yo(n,t){if(R.get(n)===void 0||R.get(n)[t]===void 0)return sa(n,t);else return R.get(n)[t]}function $o(n,t,e){e=e+"";let a=Yo(n,t)[e];if(a===void 0||Nn(n[a],t)+""!==e)a=sa(n,t)[e];return a}function Lo(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function la(n,t,e,a){let o=t!==""?$o(n,t,e):e;if(a===Xt)return n.splice(o,1),R.delete(n),Symbol("deleted");else if(a===oa){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&Nn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw new Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function Fe(n){if(!Array.isArray(n))throw aa("setByPath failed: expected array, found",n)}function Ye(n){if(n==null||!(n instanceof Object))throw aa("setByPath failed: expected Object, found",n)}function Nn(n,t){let e=ia(t),a=n,o,i,s,l;for(o=0,i=e.length;a!==void 0&&o<i;o++){let d=e[o];if(Array.isArray(d))for(s=0,l=d.length;a!==void 0&&s<l;s++){let h=d[s];a=a[h]}else if(a.length===0){if(a=a[d.slice(1)],d[0]!=="=")return}else if(d.includes("=")){let[h,...m]=d.split("=");a=la(a,h,m.join("="))}else s=parseInt(d,10),a=a[s]}return a}function Go(n,t,e){let a=n,o=ia(t);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)Ye(a);else Fe(a);let l=i.slice(0,s),d=i.slice(s+1);if(a=la(a,l,d,o.length>0?oa:e),o.length===0)return!0}else{Fe(a);let l=parseInt(i,10);if(o.length>0)a=a[l];else{if(e!==Xt){if(a[l]===e)return!1;a[l]=e}else a.splice(l,1);return!0}}}else if(Array.isArray(i)&&i.length>0){Ye(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=Lo(a,s,i.length>0?{}:[]);else{if(e!==Xt){if(a[s]===e)return!1;a[s]=e}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw new Error(`setByPath failed, bad path ${t}`)}throw new Error(`setByPath(${n}, ${t}, ${e}) failed`)}var Jo=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],qt={},Ro=!0,Uo=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,Ko=(n)=>Uo.test(n),an=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},Zo={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}};function Ot(n,t){let e=typeof n;if(n===void 0||e==="object"||e==="function")return n;else return new Proxy(Zo[typeof n](n),jn(t,!0))}var jn=(n,t)=>({get(e,a){switch(a){case U:return n;case zn:return e.valueOf?e.valueOf():e;case Bo:return(s)=>{let l=ea(n,s);return()=>st(l)};case Vo:return(s,l)=>rt(s,l,V(e));case Do:return(s,l,d)=>{X(s,n,l,d)}}if(typeof a==="symbol")return e[a];let o=a,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,l]=i,d=an(n,s),h=Nn(e,s);return h!==null&&typeof h==="object"?new Proxy(h,jn(d,t))[l]:h}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(e)&&e[o]!==void 0||Array.isArray(e)&&o.includes("=")){let s;if(o.includes("=")){let[l,d]=o.split("=");s=e.find((h)=>`${Nn(h,l)}`===d)}else s=e[o];if(s instanceof Object){let l=an(n,o);return new Proxy(s instanceof Function?s.bind(e):s,jn(l,t))}else return t?Ot(s,an(n,o)):s}else if(Array.isArray(e)){let s=e[o];return typeof s==="function"?(...l)=>{let d=s.apply(e,l);if(Jo.includes(o))rn(n);return d}:typeof s==="object"?new Proxy(s,jn(an(n,o),t)):t?Ot(s,an(n,o)):s}else return t?Ot(e[o],an(n,o)):e[o]},set(e,a,o){o=V(o);let i=a!==zn?an(n,a):n;if(Ro&&!Ko(i))throw new Error(`setting invalid path ${i}`);if(V(P[i])!==o&&Go(qt,i,o))rn(i);return!0}}),$n=(n,t)=>{let e=typeof t==="function"?t:P[t];if(typeof e!=="function")throw new Error(`observe expects a function or path to a function, ${t} is neither`);return ea(n,e)},P=new Proxy(qt,jn("",!1)),En=new Proxy(qt,jn("",!0)),ra=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},da=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},$e=(n,t)=>{switch(da(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},Qo=(n)=>{switch(da(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:Le}=globalThis,Nt=Le!=null?new Le((n)=>{for(let t of n){let e=t.target;ra(e,"resize")}}):{observe(){},unobserve(){}},Ge=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?Xn(a):a)});else if(t instanceof Node)n.append(e?Xn(t):t);else throw new Error("expect text content or document node")},lt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},Wn=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(e),e=setTimeout(async()=>{n(...i),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},Wt=Symbol("list-binding"),ko=16,ni=100;function Je(n,t){let e=Array.from(n.querySelectorAll(Cn));if(n.matches(Cn))e.unshift(n);for(let a of e){let o=ln.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,P[i.path])}}}class ha{boundElement;listTop;listBottom;template;options;itemToElement;_array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw new Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw new Error("ListBinding expects a template with exactly one child element");this.template=Xn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),this.options=e,e.virtual!=null)Nt.observe(this.boundElement),this._update=Wn(()=>{this.update(this._array,!0)},ko),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this._array;if(t!==void 0)a=a.filter((d)=>d[t]!==!0);if(e!==void 0)a=a.filter((d)=>d[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,i=a.length-1,s=0,l=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,h=this.boundElement.offsetHeight,m=n.width!=null?Math.max(1,Math.floor(d/n.width)):1,p=Math.ceil(h/n.height)+1,u=Math.ceil(a.length/m),S=m*p,T=Math.floor(this.boundElement.scrollTop/n.height);if(T>u-p+1)T=Math.max(0,u-p+1);o=T*m,i=o+S-1,s=T*n.height,l=Math.max(u*n.height-h-s,0)}return{items:a,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:l}}needle;filter=Wn((n)=>{if(this.needle!==n)this.needle=n,this.update(this._array)},ni);update(n,t){if(n==null)n=[];this._array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Yn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:l,lastItem:d,topBuffer:h,bottomBuffer:m}=i;if(e===void 0&&a===void 0&&t===!0&&s!=null&&l===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let p=0,u=0,S=0;for(let x of Array.from(this.boundElement.children)){if(x===this.listTop||x===this.listBottom)continue;let A=et.get(x);if(A==null)x.remove();else{let M=i.items.indexOf(A);if(M<l||M>d)x.remove(),this.itemToElement.delete(A),et.delete(x),p++}}this.listTop.style.height=String(h)+"px",this.listBottom.style.height=String(m)+"px";let T=[],{idPath:z}=this.options;for(let x=l;x<=d;x++){let A=i.items[x];if(A===void 0)continue;let M=this.itemToElement.get(V(A));if(M==null){if(S++,M=Xn(this.template),typeof A==="object")this.itemToElement.set(V(A),M),et.set(M,V(A));if(this.boundElement.insertBefore(M,this.listBottom),z!=null){let D=A[z],H=`${o}[${z}=${D}]`;Je(M,H)}else{let D=`${o}[${x}]`;Je(M,D)}}T.push(M)}let E=null;for(let x of T){if(x.previousElementSibling!==E)if(u++,E?.nextElementSibling!=null)this.boundElement.insertBefore(x,E.nextElementSibling);else this.boundElement.insertBefore(x,this.listBottom);E=x}if(at.perf)console.log(o,"updated",{removed:p,created:S,moved:u})}}var ti=(n,t,e)=>{let a=n[Wt];if(a===void 0)a=new ha(n,t,e),n[Wt]=a;return a},{document:qn,MutationObserver:Re}=globalThis,Ft=(n,t)=>{let e=ln.get(n);if(e==null)return;for(let a of e){let{binding:o,options:i}=a,{path:s}=a,{toDOM:l}=o;if(l!=null){if(s.startsWith("^")){let d=hn(n);if(d!=null&&d[U]!=null)s=a.path=`${d[U]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),new Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))l(n,P[s],i)}}};if(Re!=null)new Re((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Cn)).forEach((a)=>Ft(a))})})}).observe(qn.body,{subtree:!0,childList:!0});$n(()=>!0,(n)=>{let t=Array.from(qn.querySelectorAll(Cn));for(let e of t)Ft(e,n)});var Ue=(n)=>{let t=n.target.closest(Cn);while(t!=null){let e=ln.get(t);for(let a of e){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let l;try{l=s(t,a.options)}catch(d){throw console.error("Cannot get value from",t,"via",a),new Error("Cannot obtain value fromDOM")}if(l!=null){let d=P[i];if(d==null)P[i]=l;else{let h=d[U]!=null?d[zn]:d,m=l[U]!=null?l[zn]:l;if(h!==m)P[i]=m}}}}t=t.parentElement.closest(Cn)}};if(globalThis.document!=null)qn.body.addEventListener("change",Ue,!0),qn.body.addEventListener("input",Ue,!0);function X(n,t,e,a){if(n instanceof DocumentFragment)throw new Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[U]===void 0&&a===void 0){let{value:l}=t;o=typeof l==="string"?l:l[U],a=t,delete a.value}else o=typeof t==="string"?t:t[U];if(o==null)throw new Error("bind requires a path or object with xin Proxy");let{toDOM:i}=e;n.classList?.add(ke);let s=ln.get(n);if(s==null)s=[],ln.set(n,s);if(s.push({path:o,binding:e,options:a}),i!=null&&!o.startsWith("^"))rn(o);if(a?.filter&&a?.needle)X(n,a.needle,{toDOM(l,d){console.log({needle:d}),l[Wt]?.filter(d)}});return n}var Ke=new Set,ei=(n)=>{let t=n?.target.closest(We),e=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let l=i[s];return typeof l==="function"?l.bind(i):l}}}),o=new Set;while(!e&&t!=null){let i=Hn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let l=P[s];if(typeof l==="function")l(a);else throw new Error(`no event handler found at path ${s}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(We):null}};function rt(n,t,e){let a=Hn.get(n);if(n.classList.add(na),a==null)a={},Hn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!Ke.has(t))Ke.add(t),qn.body.addEventListener(t,ei,!0);return()=>{a[t].delete(e)}}var K={value:{toDOM:$e,fromDOM(n){return Qo(n)}},set:{toDOM:$e},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},style:{toDOM(n,t){}},callback:{toDOM(n,t,e){if(e?.callback)e.callback(n,t);else if(t instanceof Function)t(n)}},list:{toDOM(n,t,e){ti(n,t,e).update(t)}}},ai=180/Math.PI,oi=Math.PI/180;function Y(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function J(n,t,e,a=!0){if(a)e=Y(0,e,1);return e*(t-n)+n}var ii={RADIANS_TO_DEGREES:ai,DEGREES_TO_RADIANS:oi,clamp:Y,lerp:J},si=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},on=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class ua{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),i=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Dn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class v{r;g;b;a;static fromCss(n){let t=n;if(Dn instanceof HTMLSpanElement)Dn.style.color=n,document.body.appendChild(Dn),t=getComputedStyle(Dn).color,Dn.remove();let[e,a,o,i]=t.match(/[\d.]+/g);return new v(Number(e),Number(a),Number(o),i==null?1:Number(i))}static fromHsl(n,t,e,a=1){return v.fromCss(`hsla(${n.toFixed(0)}, ${(t*100).toFixed(0)}%, ${(e*100).toFixed(0)}%, ${a.toFixed(2)})`)}constructor(n,t,e,a=1){this.r=Y(0,n,255),this.g=Y(0,t,255),this.b=Y(0,e,255),this.a=a!==void 0?Y(0,a,1):a=1}get inverse(){return new v(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return v.fromHsl(n,t,1-e,this.a)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new ua(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}, ${(t*100).toFixed(0)}%, ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsla(${n.toFixed(0)}, ${(t*100).toFixed(0)}%, ${(e*100).toFixed(0)}%, ${this.a.toFixed(2)})`}get mono(){let n=this.brightness*255;return new v(n,n,n)}get brightness(){return si(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+on(this.r)+on(this.g)+on(this.b):"#"+on(this.r)+on(this.g)+on(this.b)+on(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=Y(0,a+n*(1-a),1);return v.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=Y(0,a*(1-n),1);return v.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=Y(0,e+n*(1-e),1);return v.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=Y(0,e*(1-n),1);return v.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return v.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return v.fromHsl(t,e,a,n)}swatch(){let{r:n,g:t,b:e,a}=this;return console.log(`%c      %c ${this.html}, rgba(${n}, ${t}, ${e}, ${a}), ${this.hsla}`,`background-color: rgba(${n}, ${t}, ${e}, ${a})`,"background-color: transparent"),this}blend(n,t){return new v(J(this.r,n.r,t),J(this.g,n.g,t),J(this.b,n.b,t),J(this.a,n.a,t))}mix(n,t){let e=this._hsl,a=n._hsl;return v.fromHsl(J(e.h,a.h,t),J(e.s,a.s,t),J(e.l,a.l,t),J(this.a,n.a,t))}}function dn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function li(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var ri="http://www.w3.org/1998/Math/MathML",di="http://www.w3.org/2000/svg",tt={},pa=(n,t,e)=>{let a=ba(dn(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},hi=(n)=>{return{toDOM(t,e){pa(t,n,e)}}},ma=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Yn(e[a]))console.log(a,e[a]),X(n,e[a],hi(a));else pa(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=dn(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},ui=(n)=>{return{toDOM(t,e){ma(t,n,e)}}},pi=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();rt(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?K[e.binding]:e.binding)!==void 0&&e.value!==void 0)X(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw new Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=K[a];if(o!==void 0)X(n,e,o);else throw new Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Yn(e))X(n,e,ui(t));else ma(n,t,e)},Yt=(n,...t)=>{if(tt[n]===void 0){let[o,i]=n.split("|");if(i===void 0)tt[n]=globalThis.document.createElement(o);else tt[n]=globalThis.document.createElementNS(i,o)}let e=tt[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(o.xinPath)e.append(g.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];pi(e,o,i)}return e},$t=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},g=new Proxy({fragment:$t},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>Yt(t,...e);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),Ln=new Proxy({fragment:$t},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>Yt(`${t}|${di}`,...e);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),ca=new Proxy({fragment:$t},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>Yt(`${t}|${ri}`,...e);return n[t]},set(){throw new Error("You may not add new properties to elements")}});function Gn(n,t){let e=g.style(Fn(t));e.id=n,document.head.append(e)}var mi=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],ba=(n,t)=>{if(typeof t==="number"&&!mi.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},ci=(n,t,e)=>{if(e===void 0)return"";if(e instanceof v)e=e.html;let a=ba(t,e);return`${n}  ${a.prop}: ${a.value};`},ya=(n,t,e="")=>{let a=dn(n);if(typeof t==="object"&&!(t instanceof v)){let o=Object.keys(t).map((i)=>ya(i,t[i],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return ci(e,a,t)},Fn=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw new Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>ya(i,a[i])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},bi=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=dn(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},yi=(n)=>{console.warn("darkMode is deprecated. Use inverseLuminance instead.");let t={};for(let e of Object.keys(n)){let a=n[e];if(typeof a==="string"&&a.match(/^(#|rgb[a]?\(|hsl[a]?\()/)!=null)a=v.fromCss(a).inverseLuminance.html,t[`--${dn(e)}`]=a}return t},Lt=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof v)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=v.fromCss(a).inverseLuminance}return t},c=new Proxy({},{get(n,t){if(n[t]===void 0){let e=`--${t.replace(/[A-Z]/g,(a)=>`-${a.toLocaleLowerCase()}`)}`;n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),r=new Proxy({},{get(n,t){if(t==="default")return c;if(n[t]==null){t=t.replace(/[A-Z]/g,(l)=>`-${l.toLocaleLowerCase()}`);let[,e,,a,o,i]=t.match(/^([^\d_]*)((_)?(\d+)(\w*))?$/),s=`--${e}`;if(o!=null){let l=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=getComputedStyle(document.body).getPropertyValue(s);n[t]=l>0?v.fromCss(d).brighten(l).rgba:v.fromCss(d).darken(-l).rgba}break;case"s":{let d=getComputedStyle(document.body).getPropertyValue(s);n[t]=l>0?v.fromCss(d).saturate(l).rgba:v.fromCss(d).desaturate(-l).rgba}break;case"h":{let d=getComputedStyle(document.body).getPropertyValue(s);n[t]=v.fromCss(d).rotate(l*100).rgba,console.log(v.fromCss(d).hsla,v.fromCss(d).rotate(l).hsla)}break;case"o":{let d=getComputedStyle(document.body).getPropertyValue(s);n[t]=v.fromCss(d).opacity(l).rgba}break;case"":n[t]=`calc(var(${s}) * ${l})`;break;default:throw console.error(i),new Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),gi=0;function Bt(){return`custom-elt${(gi++).toString(36)}`}var Ze=0,Vn={};function fi(n,t){let e=Vn[n],a=Fn(t).replace(/:host\b/g,n);Vn[n]=e?e+`
`+a:a}function wi(n){if(Vn[n])document.head.append(g.style({id:n+"-component"},Vn[n]));delete Vn[n]}class y extends HTMLElement{static elements=g;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=g.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),g.style(Fn(n))}static elementCreator(n={}){if(this._elementCreator==null){let{tag:t,styleSpec:e}=n,a=n!=null?t:null;if(a==null)if(typeof this.name==="string"&&this.name!==""){if(a=dn(this.name),a.startsWith("-"))a=a.slice(1)}else a=Bt();if(customElements.get(a)!=null)console.warn(`${a} is already defined`);if(a.match(/\w+(-\w+)+/)==null)console.warn(`${a} is not a legal tag for a custom-element`),a=Bt();while(customElements.get(a)!==void 0)a=Bt();if(this._tagName=a,e!==void 0)fi(a,e);window.customElements.define(a,this,n),this._elementCreator=g[a]}return this._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((i)=>{o=!!(i.attributeName&&n.includes(li(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=sn(this[a]);let o=dn(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(i){if(typeof t[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),e[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):sn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw new Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();Ze+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Ze}`,this._value=sn(this.defaultValue)}connectedCallback(){if(wi(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(Nt.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){Nt.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)ra(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content():this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=g.style(Fn(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Ge(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);Ge(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(Gt.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((l)=>{s[l.name]=l}),o.forEach((l)=>{let d=s[""],h=l instanceof Element?s[l.slot]:d;(h!==void 0?h:d).append(l)})}}this._hydrated=!0}}render(){}}class Gt extends y{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Cl=Gt.elementCreator({tag:"xin-slot"}),Jt=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(P[o]!==void 0)Object.assign(P[o],a[o]);else P[o]=a[o]}let e=lt(()=>{let a={},o=V(P);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);$n(n,e)},dt="0.1.0";function un(n){return Object.assign(En,n),En}var Qe=!1;function Sn(n,t=!1){if(t){if(!Qe)console.warn("xinProxy(..., true) is deprecated; use boxedProxy(...) instead"),Qe=!0;return un(n)}return Object.keys(n).forEach((e)=>{P[e]=n[e]}),P}var vi={};async function Rt(n,t){let{type:e,styleSpec:a}=await t(n,{Color:v,Component:y,elements:g,svgElements:Ln,mathML:ca,varDefault:c,vars:r,xin:P,boxed:En,xinProxy:Sn,boxedProxy:un,makeComponent:Rt,bind:X,on:rt,version:dt}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return vi[n]=o,o}var Dt={},xi=(n)=>import(n);class ht extends y{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Dt[a]===void 0)Dt[a]=xi(t).then((o)=>{let i=o[e];return Rt(n,i)});else console.log(`using cached ${n}`);this.loaded=await Dt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var ji=ht.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class Ut extends y{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(ht.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Ci=Ut.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var He={};Ne(He,{xrControllersText:()=>Bs,xrControllers:()=>Os,xinjs:()=>Jn,xinTagList:()=>ml,xinTag:()=>Eo,xinSizer:()=>dl,xinSelect:()=>me,xinSegmented:()=>rl,xinRating:()=>Ks,xinPasswordStrength:()=>Us,xinNotification:()=>fo,xinMenu:()=>ls,xinLocalized:()=>St,xinForm:()=>_s,xinFloat:()=>ie,xinField:()=>Is,xinCarousel:()=>Ui,version:()=>ze,updateLocalized:()=>ce,trackDrag:()=>tn,tabSelector:()=>yo,svgIcon:()=>Li,svg2DataUrl:()=>Ua,styleSheet:()=>Ra,spacer:()=>An,sizeBreak:()=>Be,sideNav:()=>Ae,setLocale:()=>ns,scriptTag:()=>fn,richTextWidgets:()=>Co,richText:()=>al,removeLastMenu:()=>vn,postNotification:()=>Js,positionFloat:()=>no,popMenu:()=>Z,popFloat:()=>ka,menu:()=>lo,markdownViewer:()=>Ee,mapBox:()=>$s,makeSorter:()=>to,makeExamplesLive:()=>qs,localize:()=>_,localePicker:()=>as,liveExample:()=>Mt,isBreached:()=>vo,initLocalization:()=>es,icons:()=>f,i18n:()=>I,gamepadText:()=>As,gamepadState:()=>bo,findHighestZ:()=>pe,filterPart:()=>Ct,filterBuilder:()=>Cs,elastic:()=>nl,editableRect:()=>fs,dragAndDrop:()=>ho,digest:()=>wo,defineIcon:()=>$i,dataTable:()=>ys,createSubMenu:()=>io,createMenuItem:()=>so,createMenuAction:()=>oo,commandButton:()=>F,colorInput:()=>Qa,codeEditor:()=>xt,bringToFront:()=>Qn,bodymovinPlayer:()=>Ji,blockStyle:()=>Me,b3d:()=>Gi,availableFilters:()=>we,abTest:()=>qi,XinTagList:()=>Ve,XinTag:()=>Pt,XinSizer:()=>De,XinSelect:()=>nt,XinSegmented:()=>Ie,XinRating:()=>Te,XinPasswordStrength:()=>Se,XinNotification:()=>wn,XinMenu:()=>ge,XinLocalized:()=>G,XinForm:()=>kn,XinFloat:()=>en,XinField:()=>Tt,XinCarousel:()=>ue,TabSelector:()=>je,SvgIcon:()=>de,SizeBreak:()=>Oe,SideNav:()=>_e,RichText:()=>Pe,MarkdownViewer:()=>Ce,MapBox:()=>gn,LocalePicker:()=>be,LiveExample:()=>On,FilterPart:()=>ve,FilterBuilder:()=>xe,EditableRect:()=>W,DataTable:()=>fe,CodeEditor:()=>_n,BodymovinPlayer:()=>In,B3d:()=>he,AbTest:()=>Pn});function Kt(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}var k=Kt();function ja(n){k=n}var Ca=/[&<>"']/,Ei=new RegExp(Ca.source,"g"),Ea=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Si=new RegExp(Ea.source,"g"),Ti={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ga=(n)=>Ti[n];function O(n,t){if(t){if(Ca.test(n))return n.replace(Ei,ga)}else if(Ea.test(n))return n.replace(Si,ga);return n}var Mi=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Sa(n){return n.replace(Mi,(t,e)=>{if(e=e.toLowerCase(),e==="colon")return":";if(e.charAt(0)==="#")return e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1));return""})}var Pi=/(^|[^\[])\^/g;function C(n,t){n=typeof n==="string"?n:n.source,t=t||"";let e={replace:(a,o)=>{return o=o.source||o,o=o.replace(Pi,"$1"),n=n.replace(a,o),e},getRegex:()=>{return new RegExp(n,t)}};return e}var Ii=/[^\w:]/g,_i=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function fa(n,t,e){if(n){let a;try{a=decodeURIComponent(Sa(e)).replace(Ii,"").toLowerCase()}catch(o){return null}if(a.indexOf("javascript:")===0||a.indexOf("vbscript:")===0||a.indexOf("data:")===0)return null}if(t&&!_i.test(e))e=Di(t,e);try{e=encodeURI(e).replace(/%25/g,"%")}catch(a){return null}return e}var ut={},Ai=/^[^:]+:\/*[^/]*$/,Oi=/^([^:]+:)[\s\S]*$/,Bi=/^([^:]+:\/*[^/]*)[\s\S]*$/;function Di(n,t){if(!ut[" "+n])if(Ai.test(n))ut[" "+n]=n+"/";else ut[" "+n]=pt(n,"/",!0);n=ut[" "+n];let e=n.indexOf(":")===-1;if(t.substring(0,2)==="//"){if(e)return t;return n.replace(Oi,"$1")+t}else if(t.charAt(0)==="/"){if(e)return t;return n.replace(Bi,"$1")+t}else return n+t}var mt={exec:function n(){}};function wa(n,t){let e=n.replace(/\|/g,(i,s,l)=>{let d=!1,h=s;while(--h>=0&&l[h]==="\\")d=!d;if(d)return"|";else return" |"}),a=e.split(/ \|/),o=0;if(!a[0].trim())a.shift();if(a.length>0&&!a[a.length-1].trim())a.pop();if(a.length>t)a.splice(t);else while(a.length<t)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(/\\\|/g,"|");return a}function pt(n,t,e){let a=n.length;if(a===0)return"";let o=0;while(o<a){let i=n.charAt(a-o-1);if(i===t&&!e)o++;else if(i!==t&&e)o++;else break}return n.slice(0,a-o)}function Vi(n,t){if(n.indexOf(t[1])===-1)return-1;let e=n.length,a=0,o=0;for(;o<e;o++)if(n[o]==="\\")o++;else if(n[o]===t[0])a++;else if(n[o]===t[1]){if(a--,a<0)return o}return-1}function zi(n,t){if(!n||n.silent)return;if(t)console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async");if(n.sanitize||n.sanitizer)console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");if(n.highlight||n.langPrefix!=="language-")console.warn("marked(): highlight and langPrefix parameters are deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-highlight.");if(n.mangle)console.warn("marked(): mangle parameter is enabled by default, but is deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install https://www.npmjs.com/package/marked-mangle, or disable by setting `{mangle: false}`.");if(n.baseUrl)console.warn("marked(): baseUrl parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-base-url.");if(n.smartypants)console.warn("marked(): smartypants parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-smartypants.");if(n.xhtml)console.warn("marked(): xhtml parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-xhtml.");if(n.headerIds||n.headerPrefix)console.warn("marked(): headerIds and headerPrefix parameters enabled by default, but are deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install  https://www.npmjs.com/package/marked-gfm-heading-id, or disable by setting `{headerIds: false}`.")}function va(n,t,e,a){let o=t.href,i=t.title?O(t.title):null,s=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){a.state.inLink=!0;let l={type:"link",raw:e,href:o,title:i,text:s,tokens:a.inlineTokens(s)};return a.state.inLink=!1,l}return{type:"image",raw:e,href:o,title:i,text:O(s)}}function Hi(n,t){let e=n.match(/^(\s+)(?:```)/);if(e===null)return t;let a=e[1];return t.split(`
`).map((o)=>{let i=o.match(/^\s+/);if(i===null)return o;let[s]=i;if(s.length>=a.length)return o.slice(a.length);return o}).join(`
`)}class Un{constructor(n){this.options=n||k}space(n){let t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){let t=this.rules.block.code.exec(n);if(t){let e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:!this.options.pedantic?pt(e,`
`):e}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let e=t[0],a=Hi(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:a}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(/#$/.test(e)){let a=pt(e,"#");if(this.options.pedantic)e=a.trim();else if(!a||/ $/.test(a))e=a.trim()}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){let t=this.rules.block.blockquote.exec(n);if(t){let e=t[0].replace(/^ *>[ \t]?/gm,""),a=this.lexer.state.top;this.lexer.state.top=!0;let o=this.lexer.blockTokens(e);return this.lexer.state.top=a,{type:"blockquote",raw:t[0],tokens:o,text:e}}}list(n){let t=this.rules.block.list.exec(n);if(t){let e,a,o,i,s,l,d,h,m,p,u,S,T=t[1].trim(),z=T.length>1,E={type:"list",raw:"",ordered:z,start:z?+T.slice(0,-1):"",loose:!1,items:[]};if(T=z?`\\d{1,9}\\${T.slice(-1)}`:`\\${T}`,this.options.pedantic)T=z?T:"[*+-]";let x=new RegExp(`^( {0,3}${T})((?:[	 ][^\\n]*)?(?:\\n|$))`);while(n){if(S=!1,!(t=x.exec(n)))break;if(this.rules.block.hr.test(n))break;if(e=t[0],n=n.substring(e.length),h=t[2].split(`
`,1)[0].replace(/^\t+/,(M)=>" ".repeat(3*M.length)),m=n.split(`
`,1)[0],this.options.pedantic)i=2,u=h.trimLeft();else i=t[2].search(/[^ ]/),i=i>4?1:i,u=h.slice(i),i+=t[1].length;if(l=!1,!h&&/^ *$/.test(m))e+=m+`
`,n=n.substring(m.length+1),S=!0;if(!S){let M=new RegExp(`^ {0,${Math.min(3,i-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),D=new RegExp(`^ {0,${Math.min(3,i-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),H=new RegExp(`^ {0,${Math.min(3,i-1)}}(?:\`\`\`|~~~)`),Bn=new RegExp(`^ {0,${Math.min(3,i-1)}}#`);while(n){if(p=n.split(`
`,1)[0],m=p,this.options.pedantic)m=m.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ");if(H.test(m))break;if(Bn.test(m))break;if(M.test(m))break;if(D.test(n))break;if(m.search(/[^ ]/)>=i||!m.trim())u+=`
`+m.slice(i);else{if(l)break;if(h.search(/[^ ]/)>=4)break;if(H.test(h))break;if(Bn.test(h))break;if(D.test(h))break;u+=`
`+m}if(!l&&!m.trim())l=!0;e+=p+`
`,n=n.substring(p.length+1),h=m.slice(i)}}if(!E.loose){if(d)E.loose=!0;else if(/\n *\n *$/.test(e))d=!0}if(this.options.gfm){if(a=/^\[[ xX]\] /.exec(u),a)o=a[0]!=="[ ] ",u=u.replace(/^\[[ xX]\] +/,"")}E.items.push({type:"list_item",raw:e,task:!!a,checked:o,loose:!1,text:u}),E.raw+=e}E.items[E.items.length-1].raw=e.trimRight(),E.items[E.items.length-1].text=u.trimRight(),E.raw=E.raw.trimRight();let A=E.items.length;for(s=0;s<A;s++)if(this.lexer.state.top=!1,E.items[s].tokens=this.lexer.blockTokens(E.items[s].text,[]),!E.loose){let M=E.items[s].tokens.filter((H)=>H.type==="space"),D=M.length>0&&M.some((H)=>/\n.*\n/.test(H.raw));E.loose=D}if(E.loose)for(s=0;s<A;s++)E.items[s].loose=!0;return E}}html(n){let t=this.rules.block.html.exec(n);if(t){let e={type:"html",block:!0,raw:t[0],pre:!this.options.sanitizer&&(t[1]==="pre"||t[1]==="script"||t[1]==="style"),text:t[0]};if(this.options.sanitize){let a=this.options.sanitizer?this.options.sanitizer(t[0]):O(t[0]);e.type="paragraph",e.text=a,e.tokens=this.lexer.inline(a)}return e}}def(n){let t=this.rules.block.def.exec(n);if(t){let e=t[1].toLowerCase().replace(/\s+/g," "),a=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",o=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline._escapes,"$1"):t[3];return{type:"def",tag:e,raw:t[0],href:a,title:o}}}table(n){let t=this.rules.block.table.exec(n);if(t){let e={type:"table",header:wa(t[1]).map((a)=>{return{text:a}}),align:t[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split(`
`):[]};if(e.header.length===e.align.length){e.raw=t[0];let a=e.align.length,o,i,s,l;for(o=0;o<a;o++)if(/^ *-+: *$/.test(e.align[o]))e.align[o]="right";else if(/^ *:-+: *$/.test(e.align[o]))e.align[o]="center";else if(/^ *:-+ *$/.test(e.align[o]))e.align[o]="left";else e.align[o]=null;a=e.rows.length;for(o=0;o<a;o++)e.rows[o]=wa(e.rows[o],e.header.length).map((d)=>{return{text:d}});a=e.header.length;for(i=0;i<a;i++)e.header[i].tokens=this.lexer.inline(e.header[i].text);a=e.rows.length;for(i=0;i<a;i++){l=e.rows[i];for(s=0;s<l.length;s++)l[s].tokens=this.lexer.inline(l[s].text)}return e}}}lheading(n){let t=this.rules.block.lheading.exec(n);if(t)return{type:"heading",raw:t[0],depth:t[2].charAt(0)==="="?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(n){let t=this.rules.block.paragraph.exec(n);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(n){let t=this.rules.block.text.exec(n);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(n){let t=this.rules.inline.escape.exec(n);if(t)return{type:"escape",raw:t[0],text:O(t[1])}}tag(n){let t=this.rules.inline.tag.exec(n);if(t){if(!this.lexer.state.inLink&&/^<a /i.test(t[0]))this.lexer.state.inLink=!0;else if(this.lexer.state.inLink&&/^<\/a>/i.test(t[0]))this.lexer.state.inLink=!1;if(!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0]))this.lexer.state.inRawBlock=!0;else if(this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0]))this.lexer.state.inRawBlock=!1;return{type:this.options.sanitize?"text":"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:this.options.sanitize?this.options.sanitizer?this.options.sanitizer(t[0]):O(t[0]):t[0]}}}link(n){let t=this.rules.inline.link.exec(n);if(t){let e=t[2].trim();if(!this.options.pedantic&&/^</.test(e)){if(!/>$/.test(e))return;let i=pt(e.slice(0,-1),"\\");if((e.length-i.length)%2===0)return}else{let i=Vi(t[2],"()");if(i>-1){let l=(t[0].indexOf("!")===0?5:4)+t[1].length+i;t[2]=t[2].substring(0,i),t[0]=t[0].substring(0,l).trim(),t[3]=""}}let a=t[2],o="";if(this.options.pedantic){let i=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(a);if(i)a=i[1],o=i[3]}else o=t[3]?t[3].slice(1,-1):"";if(a=a.trim(),/^</.test(a))if(this.options.pedantic&&!/>$/.test(e))a=a.slice(1);else a=a.slice(1,-1);return va(t,{href:a?a.replace(this.rules.inline._escapes,"$1"):a,title:o?o.replace(this.rules.inline._escapes,"$1"):o},t[0],this.lexer)}}reflink(n,t){let e;if((e=this.rules.inline.reflink.exec(n))||(e=this.rules.inline.nolink.exec(n))){let a=(e[2]||e[1]).replace(/\s+/g," ");if(a=t[a.toLowerCase()],!a){let o=e[0].charAt(0);return{type:"text",raw:o,text:o}}return va(e,a,e[0],this.lexer)}}emStrong(n,t,e=""){let a=this.rules.inline.emStrong.lDelim.exec(n);if(!a)return;if(a[3]&&e.match(/[\p{L}\p{N}]/u))return;if(!(a[1]||a[2])||!e||this.rules.inline.punctuation.exec(e)){let i=a[0].length-1,s,l,d=i,h=0,m=a[0][0]==="*"?this.rules.inline.emStrong.rDelimAst:this.rules.inline.emStrong.rDelimUnd;m.lastIndex=0,t=t.slice(-1*n.length+i);while((a=m.exec(t))!=null){if(s=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!s)continue;if(l=s.length,a[3]||a[4]){d+=l;continue}else if(a[5]||a[6]){if(i%3&&!((i+l)%3)){h+=l;continue}}if(d-=l,d>0)continue;l=Math.min(l,l+d+h);let p=n.slice(0,i+a.index+l+1);if(Math.min(i,l)%2){let S=p.slice(1,-1);return{type:"em",raw:p,text:S,tokens:this.lexer.inlineTokens(S)}}let u=p.slice(2,-2);return{type:"strong",raw:p,text:u,tokens:this.lexer.inlineTokens(u)}}}}codespan(n){let t=this.rules.inline.code.exec(n);if(t){let e=t[2].replace(/\n/g," "),a=/[^ ]/.test(e),o=/^ /.test(e)&&/ $/.test(e);if(a&&o)e=e.substring(1,e.length-1);return e=O(e,!0),{type:"codespan",raw:t[0],text:e}}}br(n){let t=this.rules.inline.br.exec(n);if(t)return{type:"br",raw:t[0]}}del(n){let t=this.rules.inline.del.exec(n);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(n,t){let e=this.rules.inline.autolink.exec(n);if(e){let a,o;if(e[2]==="@")a=O(this.options.mangle?t(e[1]):e[1]),o="mailto:"+a;else a=O(e[1]),o=a;return{type:"link",raw:e[0],text:a,href:o,tokens:[{type:"text",raw:a,text:a}]}}}url(n,t){let e;if(e=this.rules.inline.url.exec(n)){let a,o;if(e[2]==="@")a=O(this.options.mangle?t(e[0]):e[0]),o="mailto:"+a;else{let i;do i=e[0],e[0]=this.rules.inline._backpedal.exec(e[0])[0];while(i!==e[0]);if(a=O(e[0]),e[1]==="www.")o="http://"+e[0];else o=e[0]}return{type:"link",raw:e[0],text:a,href:o,tokens:[{type:"text",raw:a,text:a}]}}}inlineText(n,t){let e=this.rules.inline.text.exec(n);if(e){let a;if(this.lexer.state.inRawBlock)a=this.options.sanitize?this.options.sanitizer?this.options.sanitizer(e[0]):O(e[0]):e[0];else a=O(this.options.smartypants?t(e[0]):e[0]);return{type:"text",raw:e[0],text:a}}}}var w={newline:/^(?: *(?:\n|$))+/,code:/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,fences:/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,hr:/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,heading:/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,blockquote:/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/,list:/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/,html:"^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))",def:/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/,table:mt,lheading:/^((?:(?!^bull ).|\n(?!\n|bull ))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,_paragraph:/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,text:/^[^\n]+/};w._label=/(?!\s*\])(?:\\.|[^\[\]\\])+/;w._title=/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/;w.def=C(w.def).replace("label",w._label).replace("title",w._title).getRegex();w.bullet=/(?:[*+-]|\d{1,9}[.)])/;w.listItemStart=C(/^( *)(bull) */).replace("bull",w.bullet).getRegex();w.list=C(w.list).replace(/bull/g,w.bullet).replace("hr","\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def","\\n+(?="+w.def.source+")").getRegex();w._tag="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul";w._comment=/<!--(?!-?>)[\s\S]*?(?:-->|$)/;w.html=C(w.html,"i").replace("comment",w._comment).replace("tag",w._tag).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();w.lheading=C(w.lheading).replace(/bull/g,w.bullet).getRegex();w.paragraph=C(w._paragraph).replace("hr",w.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",w._tag).getRegex();w.blockquote=C(w.blockquote).replace("paragraph",w.paragraph).getRegex();w.normal={...w};w.gfm={...w.normal,table:"^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)"};w.gfm.table=C(w.gfm.table).replace("hr",w.hr).replace("heading"," {0,3}#{1,6} ").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",w._tag).getRegex();w.gfm.paragraph=C(w._paragraph).replace("hr",w.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("table",w.gfm.table).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",w._tag).getRegex();w.pedantic={...w.normal,html:C(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",w._comment).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:mt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:C(w.normal._paragraph).replace("hr",w.hr).replace("heading",` *#{1,6} *[^
]`).replace("lheading",w.lheading).replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").getRegex()};var b={escape:/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:mt,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",link:/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(ref)\]/,nolink:/^!?\[(ref)\](?:\[\])?/,reflinkSearch:"reflink|nolink(?!\\()",emStrong:{lDelim:/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,rDelimAst:/^[^_*]*?__[^_*]*?\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\*)[punct](\*+)(?=[\s]|$)|[^punct\s](\*+)(?!\*)(?=[punct\s]|$)|(?!\*)[punct\s](\*+)(?=[^punct\s])|[\s](\*+)(?!\*)(?=[punct])|(?!\*)[punct](\*+)(?!\*)(?=[punct])|[^punct\s](\*+)(?=[^punct\s])/,rDelimUnd:/^[^_*]*?\*\*[^_*]*?_[^_*]*?(?=\*\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\s]|$)|[^punct\s](_+)(?!_)(?=[punct\s]|$)|(?!_)[punct\s](_+)(?=[^punct\s])|[\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])/},code:/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br:/^( {2,}|\\)\n(?!\s*$)/,del:mt,text:/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,punctuation:/^((?![*_])[\spunctuation])/};b._punctuation="\\p{P}$+<=>`^|~";b.punctuation=C(b.punctuation,"u").replace(/punctuation/g,b._punctuation).getRegex();b.blockSkip=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g;b.anyPunctuation=/\\[punct]/g;b._escapes=/\\([punct])/g;b._comment=C(w._comment).replace("(?:-->|$)","-->").getRegex();b.emStrong.lDelim=C(b.emStrong.lDelim,"u").replace(/punct/g,b._punctuation).getRegex();b.emStrong.rDelimAst=C(b.emStrong.rDelimAst,"gu").replace(/punct/g,b._punctuation).getRegex();b.emStrong.rDelimUnd=C(b.emStrong.rDelimUnd,"gu").replace(/punct/g,b._punctuation).getRegex();b.anyPunctuation=C(b.anyPunctuation,"gu").replace(/punct/g,b._punctuation).getRegex();b._escapes=C(b._escapes,"gu").replace(/punct/g,b._punctuation).getRegex();b._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/;b._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/;b.autolink=C(b.autolink).replace("scheme",b._scheme).replace("email",b._email).getRegex();b._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/;b.tag=C(b.tag).replace("comment",b._comment).replace("attribute",b._attribute).getRegex();b._label=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/;b._href=/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/;b._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/;b.link=C(b.link).replace("label",b._label).replace("href",b._href).replace("title",b._title).getRegex();b.reflink=C(b.reflink).replace("label",b._label).replace("ref",w._label).getRegex();b.nolink=C(b.nolink).replace("ref",w._label).getRegex();b.reflinkSearch=C(b.reflinkSearch,"g").replace("reflink",b.reflink).replace("nolink",b.nolink).getRegex();b.normal={...b};b.pedantic={...b.normal,strong:{start:/^__|\*\*/,middle:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,endAst:/\*\*(?!\*)/g,endUnd:/__(?!_)/g},em:{start:/^_|\*/,middle:/^()\*(?=\S)([\s\S]*?\S)\*(?!\*)|^_(?=\S)([\s\S]*?\S)_(?!_)/,endAst:/\*(?!\*)/g,endUnd:/_(?!_)/g},link:C(/^!?\[(label)\]\((.*?)\)/).replace("label",b._label).getRegex(),reflink:C(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",b._label).getRegex()};b.gfm={...b.normal,escape:C(b.escape).replace("])","~|])").getRegex(),_extended_email:/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,url:/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/};b.gfm.url=C(b.gfm.url,"i").replace("email",b.gfm._extended_email).getRegex();b.breaks={...b.gfm,br:C(b.br).replace("{2,}","*").getRegex(),text:C(b.gfm.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()};function Xi(n){return n.replace(/---/g,"—").replace(/--/g,"–").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1‘").replace(/'/g,"’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1“").replace(/"/g,"”").replace(/\.{3}/g,"…")}function xa(n){let t="",e,a,o=n.length;for(e=0;e<o;e++){if(a=n.charCodeAt(e),Math.random()>0.5)a="x"+a.toString(16);t+="&#"+a+";"}return t}class ${constructor(n){this.tokens=[],this.tokens.links=Object.create(null),this.options=n||k,this.options.tokenizer=this.options.tokenizer||new Un,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={block:w.normal,inline:b.normal};if(this.options.pedantic)t.block=w.pedantic,t.inline=b.pedantic;else if(this.options.gfm)if(t.block=w.gfm,this.options.breaks)t.inline=b.breaks;else t.inline=b.gfm;this.tokenizer.rules=t}static get rules(){return{block:w,inline:b}}static lex(n,t){return new $(t).lex(n)}static lexInline(n,t){return new $(t).inlineTokens(n)}lex(n){n=n.replace(/\r\n|\r/g,`
