var Ao=Object.defineProperty;var Ft=(n,e)=>{for(var t in e)Ao(n,t,{get:e[t],enumerable:!0,configurable:!0,set:(a)=>e[t]=()=>a})};var Rn={};Ft(Rn,{xinValue:()=>z,xinProxy:()=>ue,xinPath:()=>Fn,xin:()=>P,version:()=>he,vars:()=>r,varDefault:()=>c,updates:()=>Xo,unobserve:()=>se,touchElement:()=>$e,touch:()=>un,tosi:()=>Jn,throttle:()=>Nn,svgElements:()=>Ln,settings:()=>ae,on:()=>de,observe:()=>Yn,mathML:()=>ya,makeComponent:()=>Ze,invertLuminance:()=>Ge,initVars:()=>gi,hotReload:()=>Ue,getListItem:()=>pn,getCssVar:()=>pa,elements:()=>g,debounce:()=>re,css:()=>qn,boxedProxy:()=>mn,boxed:()=>le,blueprintLoader:()=>Si,blueprint:()=>ji,bindings:()=>U,bind:()=>H,StyleSheet:()=>$n,MoreMath:()=>li,Component:()=>y,Color:()=>v,BlueprintLoader:()=>Qe,Blueprint:()=>pe});var ae={debug:!1,perf:!1};function dn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(dn);let e={};for(let t in n){let a=n[t];if(n!=null&&typeof n==="object")e[t]=dn(a);else e[t]=a}return e}var na="-xin-data",En=`.${na}`,ea="-xin-event",Yt=`.${ea}`,K="xinPath",zn="xinValue",Oo="xinObserve",zo="xinBind",Vo="xinOn",Fn=(n)=>{return n&&n[K]||void 0};function z(n){return typeof n==="object"&&n!==null?n[zn]||n:n}var Vn=new WeakMap,hn=new WeakMap,Xn=(n)=>{let e=n.cloneNode();if(e instanceof Element){let t=hn.get(n),a=Vn.get(n);if(t!=null)hn.set(e,dn(t));if(a!=null)Vn.set(e,dn(a))}for(let t of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(t instanceof Element||t instanceof DocumentFragment)e.appendChild(Xn(t));else e.appendChild(t.cloneNode());return e},te=new WeakMap,pn=(n)=>{let e=document.body.parentElement;while(n.parentElement!=null&&n.parentElement!==e){let t=te.get(n);if(t!=null)return t;n=n.parentElement}return!1},Lt=Symbol("observer should be removed"),oe=[],ie=[],He=!1,Ne,We;class ta{description;test;callback;constructor(n,e){let t=typeof e==="string"?`"${e}"`:`function ${e.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw new Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${t}`,typeof e==="function")this.callback=e;else throw new Error("expect callback to be a path or function");oe.push(this)}}var Xo=async()=>{if(Ne===void 0)return;await Ne},Ho=()=>{if(ae.perf)console.time("xin async update");let n=Array.from(ie);for(let e of n)oe.filter((t)=>{let a;try{a=t.test(e)}catch(o){throw new Error(`Listener ${t.description} threw "${o}" at "${e}"`)}if(a===Lt)return se(t),!1;return a}).forEach((t)=>{let a;try{a=t.callback(e)}catch(o){console.error(`Listener ${t.description} threw "${o}" handling "${e}"`)}if(a===Lt)se(t)});if(ie.splice(0),He=!1,typeof We==="function")We();if(ae.perf)console.timeEnd("xin async update")},un=(n)=>{let e=typeof n==="string"?n:Fn(n);if(e===void 0)throw console.error("touch was called on an invalid target",n),new Error("touch was called on an invalid target");if(He===!1)Ne=new Promise((t)=>{We=t}),He=setTimeout(Ho);if(ie.find((t)=>e.startsWith(t))==null)ie.push(e)},aa=(n,e)=>{return new ta(n,e)},se=(n)=>{let e=oe.indexOf(n);if(e>-1)oe.splice(e,1);else throw new Error("unobserve failed, listener not found")},No=(n)=>{try{return JSON.stringify(n)}catch(e){return"{has circular references}"}},oa=(...n)=>new Error(n.map(No).join(" ")),Wo=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),qo=0,Fo=()=>(parseInt("10000",36)+ ++qo).toString(36).slice(-5),Yo=()=>Wo()+Fo(),qe={},ia={};function sa(n){if(n==="")return[];if(Array.isArray(n))return n;else{let e=[];while(n.length>0){let t=n.search(/\[[^\]]+\]/);if(t===-1){e.push(n.split("."));break}else{let a=n.slice(0,t);if(n=n.slice(t),a!=="")e.push(a.split("."));if(t=n.indexOf("]")+1,e.push(n.slice(1,t-1)),n.slice(t,t+1)===".")t+=1;n=n.slice(t)}}return e}}var G=new WeakMap;function la(n,e){if(G.get(n)===void 0)G.set(n,{});if(G.get(n)[e]===void 0)G.get(n)[e]={};let t=G.get(n)[e];if(e==="_auto_")n.forEach((a,o)=>{if(a._auto_===void 0)a._auto_=Yo();t[a._auto_+""]=o});else n.forEach((a,o)=>{t[Hn(a,e)+""]=o});return t}function Lo(n,e){if(G.get(n)===void 0||G.get(n)[e]===void 0)return la(n,e);else return G.get(n)[e]}function $o(n,e,t){t=t+"";let a=Lo(n,e)[t];if(a===void 0||Hn(n[a],e)+""!==t)a=la(n,e)[t];return a}function Jo(n,e,t){if(n[e]===void 0&&t!==void 0)n[e]=t;return n[e]}function ra(n,e,t,a){let o=e!==""?$o(n,e,t):t;if(a===qe)return n.splice(o,1),G.delete(n),Symbol("deleted");else if(a===ia){if(e===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(e!==""&&Hn(a,e)+""===t+"")n.push(a),o=n.length-1;else throw new Error(`byIdPath insert failed at [${e}=${t}]`);return n[o]}function $t(n){if(!Array.isArray(n))throw oa("setByPath failed: expected array, found",n)}function Jt(n){if(n==null||!(n instanceof Object))throw oa("setByPath failed: expected Object, found",n)}function Hn(n,e){let t=sa(e),a=n,o,i,s,l;for(o=0,i=t.length;a!==void 0&&o<i;o++){let d=t[o];if(Array.isArray(d))for(s=0,l=d.length;a!==void 0&&s<l;s++){let h=d[s];a=a[h]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[h,...m]=d.split("=");a=ra(a,h,m.join("="))}else s=parseInt(d,10),a=a[s]}return a}function Ro(n,e,t){let a=n,o=sa(e);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)Jt(a);else $t(a);let l=i.slice(0,s),d=i.slice(s+1);if(a=ra(a,l,d,o.length>0?ia:t),o.length===0)return!0}else{$t(a);let l=parseInt(i,10);if(o.length>0)a=a[l];else{if(t!==qe){if(a[l]===t)return!1;a[l]=t}else a.splice(l,1);return!0}}}else if(Array.isArray(i)&&i.length>0){Jt(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=Jo(a,s,i.length>0?{}:[]);else{if(t!==qe){if(a[s]===t)return!1;a[s]=t}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw new Error(`setByPath failed, bad path ${e}`)}throw new Error(`setByPath(${n}, ${e}, ${t}) failed`)}var Go=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],Le={},Ko=!0,Uo=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,Zo=(n)=>Uo.test(n),ln=(n="",e="")=>{if(n==="")return e;else if(e.match(/^\d+$/)!==null||e.includes("="))return`${n}[${e}]`;else return`${n}.${e}`},Qo={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}};function ze(n,e){let t=typeof n;if(n===void 0||t==="object"||t==="function")return n;else return new Proxy(Qo[typeof n](n),Sn(e,!0))}var Sn=(n,e)=>({get(t,a){switch(a){case K:return n;case zn:return t.valueOf?t.valueOf():t;case Oo:return(s)=>{let l=aa(n,s);return()=>se(l)};case Vo:return(s,l)=>de(s,l,z(t));case zo:return(s,l,d)=>{H(s,n,l,d)}}if(typeof a==="symbol")return t[a];let o=a,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,l]=i,d=ln(n,s),h=Hn(t,s);return h!==null&&typeof h==="object"?new Proxy(h,Sn(d,e))[l]:h}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(t)&&t[o]!==void 0||Array.isArray(t)&&o.includes("=")){let s;if(o.includes("=")){let[l,d]=o.split("=");s=t.find((h)=>`${Hn(h,l)}`===d)}else s=t[o];if(s instanceof Object){let l=ln(n,o);return new Proxy(s instanceof Function?s.bind(t):s,Sn(l,e))}else return e?ze(s,ln(n,o)):s}else if(Array.isArray(t)){let s=t[o];return typeof s==="function"?(...l)=>{let d=s.apply(t,l);if(Go.includes(o))un(n);return d}:typeof s==="object"?new Proxy(s,Sn(ln(n,o),e)):e?ze(s,ln(n,o)):s}else return e?ze(t[o],ln(n,o)):t[o]},set(t,a,o){o=z(o);let i=a!==zn?ln(n,a):n;if(Ko&&!Zo(i))throw new Error(`setting invalid path ${i}`);if(z(P[i])!==o&&Ro(Le,i,o))un(i);return!0}}),Yn=(n,e)=>{let t=typeof e==="function"?e:P[e];if(typeof t!=="function")throw new Error(`observe expects a function or path to a function, ${e} is neither`);return aa(n,t)},P=new Proxy(Le,Sn("",!1)),le=new Proxy(Le,Sn("",!0)),da=(n,e)=>{let t=new Event(e);n.dispatchEvent(t)},ha=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},ko=(n,e)=>{switch(ha(n)){case"radio":n.checked=n.value===e;break;case"checkbox":n.checked=!!e;break;case"date":n.valueAsDate=new Date(e);break;case"multi-select":for(let t of Array.from(n.querySelectorAll("option")))t.selected=e[t.value];break;default:n.value=e}},ni=(n)=>{switch(ha(n)){case"radio":{let e=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return e!=null?e.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((e,t)=>{return e[t.value]=t.selected,e},{});default:return n.value}},{ResizeObserver:Rt}=globalThis,Fe=Rt!=null?new Rt((n)=>{for(let e of n){let t=e.target;da(t,"resize")}}):{observe(){},unobserve(){}},Gt=(n,e,t=!0)=>{if(n!=null&&e!=null)if(typeof e==="string")n.textContent=e;else if(Array.isArray(e))e.forEach((a)=>{n.append(a instanceof Node&&t?Xn(a):a)});else if(e instanceof Node)n.append(t?Xn(e):e);else throw new Error("expect text content or document node")},re=(n,e=250)=>{let t;return(...a)=>{if(t!==void 0)clearTimeout(t);t=setTimeout(()=>{n(...a)},e)}},Nn=(n,e=250)=>{let t,a=Date.now()-e,o=!1;return(...i)=>{if(clearTimeout(t),t=setTimeout(async()=>{n(...i),a=Date.now()},e),!o&&Date.now()-a>=e){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},Ye=Symbol("list-binding"),ei=16,ti=100;function Kt(n,e){let t=Array.from(n.querySelectorAll(En));if(n.matches(En))t.unshift(n);for(let a of t){let o=hn.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${e}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,P[i.path])}}}class ua{boundElement;listTop;listBottom;template;options;itemToElement;_array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,e,t={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw new Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw new Error("ListBinding expects a template with exactly one child element");this.template=Xn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),this.options=t,t.virtual!=null)Fe.observe(this.boundElement),this._update=Nn(()=>{this.update(this._array,!0)},ei),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:e,visibleProp:t}=this.options,a=this._array;if(e!==void 0)a=a.filter((d)=>d[e]!==!0);if(t!==void 0)a=a.filter((d)=>d[t]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,i=a.length-1,s=0,l=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,h=this.boundElement.offsetHeight,m=n.width!=null?Math.max(1,Math.floor(d/n.width)):1,p=Math.ceil(h/n.height)+1,u=Math.ceil(a.length/m),E=m*p,T=Math.floor(this.boundElement.scrollTop/n.height);if(T>u-p+1)T=Math.max(0,u-p+1);o=T*m,i=o+E-1,s=T*n.height,l=Math.max(u*n.height-h-s,0)}return{items:a,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:l}}needle;filter=Nn((n)=>{if(this.needle!==n)this.needle=n,this.update(this._array)},ti);update(n,e){if(n==null)n=[];this._array=n;let{hiddenProp:t,visibleProp:a}=this.options,o=Fn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:l,lastItem:d,topBuffer:h,bottomBuffer:m}=i;if(t===void 0&&a===void 0&&e===!0&&s!=null&&l===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let p=0,u=0,E=0;for(let x of Array.from(this.boundElement.children)){if(x===this.listTop||x===this.listBottom)continue;let D=te.get(x);if(D==null)x.remove();else{let M=i.items.indexOf(D);if(M<l||M>d)x.remove(),this.itemToElement.delete(D),te.delete(x),p++}}this.listTop.style.height=String(h)+"px",this.listBottom.style.height=String(m)+"px";let T=[],{idPath:V}=this.options;for(let x=l;x<=d;x++){let D=i.items[x];if(D===void 0)continue;let M=this.itemToElement.get(z(D));if(M==null){if(E++,M=Xn(this.template),typeof D==="object")this.itemToElement.set(z(D),M),te.set(M,z(D));if(this.boundElement.insertBefore(M,this.listBottom),V!=null){let O=D[V],X=`${o}[${V}=${O}]`;Kt(M,X)}else{let O=`${o}[${x}]`;Kt(M,O)}}T.push(M)}let S=null;for(let x of T){if(x.previousElementSibling!==S)if(u++,S?.nextElementSibling!=null)this.boundElement.insertBefore(x,S.nextElementSibling);else this.boundElement.insertBefore(x,this.listBottom);S=x}if(ae.perf)console.log(o,"updated",{removed:p,created:E,moved:u})}}var ai=(n,e,t)=>{let a=n[Ye];if(a===void 0)a=new ua(n,e,t),n[Ye]=a;return a},{document:Wn,MutationObserver:Ut}=globalThis,$e=(n,e)=>{let t=hn.get(n);if(t==null)return;for(let a of t){let{binding:o,options:i}=a,{path:s}=a,{toDOM:l}=o;if(l!=null){if(s.startsWith("^")){let d=pn(n);if(d!=null&&d[K]!=null)s=a.path=`${d[K]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),new Error(`Cannot resolve relative binding ${s}`)}if(e==null||s.startsWith(e))l(n,P[s],i)}}};if(Ut!=null)new Ut((n)=>{n.forEach((e)=>{Array.from(e.addedNodes).forEach((t)=>{if(t instanceof Element)Array.from(t.querySelectorAll(En)).forEach((a)=>$e(a))})})}).observe(Wn.body,{subtree:!0,childList:!0});Yn(()=>!0,(n)=>{let e=Array.from(Wn.querySelectorAll(En));for(let t of e)$e(t,n)});var Zt=(n)=>{let e=n.target.closest(En);while(e!=null){let t=hn.get(e);for(let a of t){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let l;try{l=s(e,a.options)}catch(d){throw console.error("Cannot get value from",e,"via",a),new Error("Cannot obtain value fromDOM")}if(l!=null){let d=P[i];if(d==null)P[i]=l;else{let h=d[K]!=null?d[zn]:d,m=l[K]!=null?l[zn]:l;if(h!==m)P[i]=m}}}}e=e.parentElement.closest(En)}};if(globalThis.document!=null)Wn.body.addEventListener("change",Zt,!0),Wn.body.addEventListener("input",Zt,!0);function H(n,e,t,a){if(n instanceof DocumentFragment)throw new Error("bind cannot bind to a DocumentFragment");let o;if(typeof e==="object"&&e[K]===void 0&&a===void 0){let{value:l}=e;o=typeof l==="string"?l:l[K],a=e,delete a.value}else o=typeof e==="string"?e:e[K];if(o==null)throw new Error("bind requires a path or object with xin Proxy");let{toDOM:i}=t;n.classList?.add(na);let s=hn.get(n);if(s==null)s=[],hn.set(n,s);if(s.push({path:o,binding:t,options:a}),i!=null&&!o.startsWith("^"))un(o);if(a?.filter&&a?.needle)H(n,a.needle,{toDOM(l,d){console.log({needle:d}),l[Ye]?.filter(d)}});return n}var Qt=new Set,oi=(n)=>{let e=n?.target.closest(Yt),t=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),t=!0};else{let l=i[s];return typeof l==="function"?l.bind(i):l}}}),o=new Set;while(!t&&e!=null){let i=Vn.get(e)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let l=P[s];if(typeof l==="function")l(a);else throw new Error(`no event handler found at path ${s}`)}if(t)continue}e=e.parentElement!=null?e.parentElement.closest(Yt):null}};function de(n,e,t){let a=Vn.get(n);if(n.classList.add(ea),a==null)a={},Vn.set(n,a);if(!a[e])a[e]=new Set;if(a[e].add(t),!Qt.has(e))Qt.add(e),Wn.body.addEventListener(e,oi,!0);return()=>{a[e].delete(t)}}var U={value:{toDOM:ko,fromDOM(n){return ni(n)}},text:{toDOM(n,e){n.textContent=e}},enabled:{toDOM(n,e){n.disabled=!e}},disabled:{toDOM(n,e){n.disabled=Boolean(e)}},list:{toDOM(n,e,t){ai(n,e,t).update(e)}}},ii=180/Math.PI,si=Math.PI/180;function L(n,e,t){return t<n?NaN:e<n?n:e>t?t:e}function Q(n,e,t,a=!0){if(a)t=L(0,t,1);return t*(e-n)+n}var li={RADIANS_TO_DEGREES:ii,DEGREES_TO_RADIANS:si,clamp:L,lerp:Q};function pa(n,e=document.body){let t=getComputedStyle(e);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return t.getPropertyValue(n).trim()}var ri=(n,e,t)=>{return(0.299*n+0.587*e+0.114*t)/255},rn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class ma{h;s;l;constructor(n,e,t){n/=255,e/=255,t/=255;let a=Math.max(n,e,t),o=a-Math.min(n,e,t),i=o!==0?a===n?(e-t)/o:a===e?2+(t-n)/o:4+(n-e)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var jn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class v{r;g;b;a;static fromVar(n,e=document.body){return v.fromCss(pa(n,e))}static fromCss(n){let e=n;if(jn instanceof HTMLSpanElement)jn.style.color="black",jn.style.color=n,document.body.appendChild(jn),e=getComputedStyle(jn).color,jn.remove();let[t,a,o,i]=e.match(/[\d.]+/g),s=e.startsWith("color(srgb")?255:1;return new v(Number(t)*s,Number(a)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,e,t,a=1){return v.fromCss(`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(a*100).toFixed(0)}%)`)}static black=new v(0,0,0);static white=new v(255,255,255);constructor(n,e,t,a=1){this.r=L(0,n,255),this.g=L(0,e,255),this.b=L(0,t,255),this.a=a!==void 0?L(0,a,1):a=1}get inverse(){return new v(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:e,l:t}=this._hsl;return v.fromHsl(n,e,1-t,this.a)}contrasting(n=1){let{h:e,s:t,l:a}=this._hsl;return this.blend(this.brightness>0.5?v.black:v.white,n)}get rgb(){let{r:n,g:e,b:t}=this;return`rgb(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)})`}get rgba(){let{r:n,g:e,b:t,a}=this;return`rgba(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new ma(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}%)`}get hsla(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new v(n,n,n)}get brightness(){return ri(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+rn(this.r)+rn(this.g)+rn(this.b):"#"+rn(this.r)+rn(this.g)+rn(this.b)+rn(Math.floor(255*this.a))}brighten(n){let{h:e,s:t,l:a}=this._hsl,o=L(0,a+n*(1-a),1);return v.fromHsl(e,t,o,this.a)}darken(n){let{h:e,s:t,l:a}=this._hsl,o=L(0,a*(1-n),1);return v.fromHsl(e,t,o,this.a)}saturate(n){let{h:e,s:t,l:a}=this._hsl,o=L(0,t+n*(1-t),1);return v.fromHsl(e,o,a,this.a)}desaturate(n){let{h:e,s:t,l:a}=this._hsl,o=L(0,t*(1-n),1);return v.fromHsl(e,o,a,this.a)}rotate(n){let{h:e,s:t,l:a}=this._hsl,o=(e+360+n)%360;return v.fromHsl(o,t,a,this.a)}opacity(n){let{h:e,s:t,l:a}=this._hsl;return v.fromHsl(e,t,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,e){return new v(Q(this.r,n.r,e),Q(this.g,n.g,e),Q(this.b,n.b,e),Q(this.a,n.a,e))}static blendHue(n,e,t){let a=(e-n+720)%360;if(a<180)return n+t*a;else return n-(360-a)*t}mix(n,e){let t=this._hsl,a=n._hsl;return v.fromHsl(t.s===0?a.h:a.s===0?t.h:v.blendHue(t.h,a.h,e),Q(t.s,a.s,e),Q(t.l,a.l,e),Q(this.a,n.a,e))}colorMix(n,e){return v.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(e*100).toFixed(0)}%)`)}}function k(n){return n.replace(/[A-Z]/g,(e)=>{return`-${e.toLocaleLowerCase()}`})}function di(n){return n.replace(/-([a-z])/g,(e,t)=>{return t.toLocaleUpperCase()})}var hi="http://www.w3.org/1998/Math/MathML",ui="http://www.w3.org/2000/svg",ee={},ca=(n,e,t)=>{let a=ga(k(e),t);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[e]=a.value},pi=(n)=>{return{toDOM(e,t){ca(e,n,t)}}},ba=(n,e,t)=>{if(e==="style")if(typeof t==="object")for(let a of Object.keys(t))if(Fn(t[a]))H(n,t[a],pi(a));else ca(n,a,t[a]);else n.setAttribute("style",t);else if(n[e]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(e,t);else n[e]=t}else{let a=k(e);if(a==="class")t.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=t;else if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t)}},mi=(n)=>{return{toDOM(e,t){ba(e,n,t)}}},ci=(n,e,t)=>{if(e==="apply")t(n);else if(e.match(/^on[A-Z]/)!=null){let a=e.substring(2).toLowerCase();de(n,a,t)}else if(e==="bind")if((typeof t.binding==="string"?U[t.binding]:t.binding)!==void 0&&t.value!==void 0)H(n,t.value,t.binding instanceof Function?{toDOM:t.binding}:t.binding);else throw new Error("bad binding");else if(e.match(/^bind[A-Z]/)!=null){let a=e.substring(4,5).toLowerCase()+e.substring(5),o=U[a];if(o!==void 0)H(n,t,o);else throw new Error(`${e} is not allowed, bindings.${a} is not defined`)}else if(Fn(t))H(n,t,mi(e));else ba(n,e,t)},Je=(n,...e)=>{if(ee[n]===void 0){let[o,i]=n.split("|");if(i===void 0)ee[n]=globalThis.document.createElement(o);else ee[n]=globalThis.document.createElementNS(i,o)}let t=ee[n].cloneNode(),a={};for(let o of e)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(t instanceof HTMLTemplateElement)t.content.append(o);else t.append(o);else if(o.xinPath)t.append(g.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];ci(t,o,i)}return t},Re=(...n)=>{let e=globalThis.document.createDocumentFragment();for(let t of n)e.append(t);return e},g=new Proxy({fragment:Re},{get(n,e){if(e=e.replace(/[A-Z]/g,(t)=>`-${t.toLocaleLowerCase()}`),n[e]===void 0)n[e]=(...t)=>Je(e,...t);return n[e]},set(){throw new Error("You may not add new properties to elements")}}),Ln=new Proxy({fragment:Re},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>Je(`${e}|${ui}`,...t);return n[e]},set(){throw new Error("You may not add new properties to elements")}}),ya=new Proxy({fragment:Re},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>Je(`${e}|${hi}`,...t);return n[e]},set(){throw new Error("You may not add new properties to elements")}});function $n(n,e){let t=g.style(qn(e));t.id=n,document.head.append(t)}var bi=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],ga=(n,e)=>{if(typeof e==="number"&&!bi.includes(n))e=`${e}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),e=`var(${n}-default, ${e})`;else n="--"+n.substring(1);return{prop:n,value:String(e)}},yi=(n,e,t)=>{if(t===void 0)return"";if(t instanceof v)t=t.html;let a=ga(e,t);return`${n}  ${a.prop}: ${a.value};`},fa=(n,e,t="")=>{let a=k(n);if(typeof e==="object"&&!(e instanceof v)){let o=Object.keys(e).map((i)=>fa(i,e[i],`${t}  `)).join(`
`);return`${t}  ${n} {
${o}
${t}  }`}else return yi(t,a,e)},qn=(n,e="")=>{return Object.keys(n).map((t)=>{let a=n[t];if(typeof a==="string"){if(t==="@import")return`@import url('${a}');`;throw new Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>fa(i,a[i])).join(`
`);return`${e}${t} {
${o}
}`}).join(`

`)},gi=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let e={};for(let t of Object.keys(n)){let a=n[t],o=k(t);e[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return e},Ge=(n)=>{let e={};for(let t of Object.keys(n)){let a=n[t];if(a instanceof v)e[t]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))e[t]=v.fromCss(a).inverseLuminance}return e},c=new Proxy({},{get(n,e){if(n[e]===void 0){let t="--"+k(e);n[e]=(a)=>`var(${t}, ${a})`}return n[e]}}),r=new Proxy({},{get(n,e){if(e==="default")return c;if(n[e]==null){e=k(e);let[,t,,a,o,i]=e.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",e],s=`--${t}`;if(o!=null){let l=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=v.fromVar(s);n[e]=l>0?d.brighten(l).rgba:d.darken(-l).rgba}break;case"s":{let d=v.fromVar(s);n[e]=l>0?d.saturate(l).rgba:d.desaturate(-l).rgba}break;case"h":{let d=v.fromVar(s);n[e]=d.rotate(l*100).rgba}break;case"o":{let d=v.fromVar(s);n[e]=d.opacity(l).rgba}break;case"":n[e]=`calc(var(${s}) * ${l})`;break;default:throw console.error(i),new Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[e]=`var(${s})`}return n[e]}}),fi=0;function Ve(){return`custom-elt${(fi++).toString(36)}`}var kt=0,On={};function wi(n,e){let t=On[n],a=qn(e).replace(/:host\b/g,n);On[n]=t?t+`
`+a:a}function vi(n){if(On[n])document.head.append(g.style({id:n+"-component"},On[n]));delete On[n]}class y extends HTMLElement{static elements=g;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=g.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),g.style(qn(n))}static elementCreator(n={}){if(this._elementCreator==null){let{tag:e,styleSpec:t}=n,a=n!=null?e:null;if(a==null)if(typeof this.name==="string"&&this.name!==""){if(a=k(this.name),a.startsWith("-"))a=a.slice(1)}else a=Ve();if(customElements.get(a)!=null)console.warn(`${a} is already defined`);if(a.match(/\w+(-\w+)+/)==null)console.warn(`${a} is not a legal tag for a custom-element`),a=Ve();while(customElements.get(a)!==void 0)a=Ve();if(this._tagName=a,t!==void 0)wi(a,t);window.customElements.define(a,this,n),this._elementCreator=g[a]}return this._elementCreator}initAttributes(...n){let e={},t={};new MutationObserver((a)=>{let o=!1;if(a.forEach((i)=>{o=!!(i.attributeName&&n.includes(di(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{e[a]=dn(this[a]);let o=k(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof e[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof e[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(t[a]!==void 0)return t[a];else return e[a]},set(i){if(typeof e[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof e[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),t[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let e=this.hasAttribute("value")?this.getAttribute("value"):dn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return e},set(t){if(e!==t)e=t,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(e,t){if(e[t]===void 0){let a=n.querySelector(`[part="${t}"]`);if(a==null)a=n.querySelector(t);if(a==null)throw new Error(`elementRef "${t}" does not exist!`);a.removeAttribute("data-ref"),e[t]=a}return e[t]}});return this._parts}constructor(){super();kt+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${kt}`,this._value=dn(this.defaultValue)}connectedCallback(){if(vi(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(Fe.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){Fe.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)da(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",e=typeof this.content==="function"?this.content():this.content,{styleSpec:t}=this.constructor,{styleNode:a}=this.constructor;if(t)a=this.constructor.styleNode=g.style(qn(t)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Gt(o,e,n)}else if(e!==null){let o=Array.from(this.childNodes);Gt(this,e,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(Ke.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((l)=>{s[l.name]=l}),o.forEach((l)=>{let d=s[""],h=l instanceof Element?s[l.slot]:d;(h!==void 0?h:d).append(l)})}}this._hydrated=!0}}render(){}}class Ke extends y{name="";content=null;static replaceSlot(n){let e=document.createElement("xin-slot");if(n.name!=="")e.setAttribute("name",n.name);n.replaceWith(e)}constructor(){super();this.initAttributes("name")}}var Sl=Ke.elementCreator({tag:"xin-slot"}),Ue=(n=()=>!0)=>{let e=localStorage.getItem("xin-state");if(e!=null){let a=JSON.parse(e);for(let o of Object.keys(a).filter(n))if(P[o]!==void 0)Object.assign(P[o],a[o]);else P[o]=a[o]}let t=re(()=>{let a={},o=z(P);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);Yn(n,t)},he="1.0.3";function Jn(n){return Object.assign(le,n),le}function mn(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),Jn(n)}function ue(n,e=!1){if(e)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),mn(n);return Object.keys(n).forEach((t)=>{P[t]=n[t]}),P}var xi={};async function Ze(n,e){let{type:t,styleSpec:a}=await e(n,{Color:v,Component:y,elements:g,svgElements:Ln,mathML:ya,varDefault:c,vars:r,xin:P,boxed:le,xinProxy:ue,boxedProxy:mn,makeComponent:Ze,bind:H,on:de,version:he}),o={type:t,creator:t.elementCreator({tag:n,styleSpec:a})};return xi[n]=o,o}var Xe={},Ci=(n)=>import(n);class pe extends y{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:e,property:t}=this,a=`${n}.${t}:${e}`;if(!this.loaded){if(Xe[a]===void 0)Xe[a]=Ci(e).then((o)=>{let i=o[t];return Ze(n,i)});else console.log(`using cached ${n}`);this.loaded=await Xe[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var ji=pe.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class Qe extends y{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(pe.tagName)).filter((e)=>e.src).map((e)=>e.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Si=Qe.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Wt={};Ft(Wt,{xrControllersText:()=>Os,xrControllers:()=>As,xinjs:()=>Rn,xinTagList:()=>cl,xinTag:()=>To,xinSizer:()=>hl,xinSelect:()=>yt,xinSegmented:()=>dl,xinRating:()=>Zs,xinPasswordStrength:()=>Us,xinNotification:()=>vo,xinMenu:()=>rs,xinLocalized:()=>Me,xinForm:()=>Ds,xinFloat:()=>rt,xinField:()=>_s,xinCarousel:()=>Ui,version:()=>Nt,updateLocalized:()=>gt,trackDrag:()=>tn,tabSelector:()=>fo,svgIcon:()=>Ji,svg2DataUrl:()=>Za,styleSheet:()=>Ua,spacer:()=>Dn,sizeBreak:()=>Vt,sideNav:()=>Ot,setLocale:()=>es,scriptTag:()=>vn,richTextWidgets:()=>Eo,richText:()=>ol,removeLastMenu:()=>Cn,postNotification:()=>Gs,positionFloat:()=>to,popMenu:()=>Z,popFloat:()=>eo,menu:()=>ho,markdownViewer:()=>Mt,mapBox:()=>$s,makeSorter:()=>ao,makeExamplesLive:()=>Fs,localize:()=>_,localePicker:()=>os,liveExample:()=>Pe,isBreached:()=>Co,initLocalization:()=>as,icons:()=>f,i18n:()=>I,gamepadText:()=>Bs,gamepadState:()=>go,findHighestZ:()=>bt,filterPart:()=>Ee,filterBuilder:()=>Ss,elastic:()=>el,editableRect:()=>ws,dragAndDrop:()=>po,digest:()=>xo,defineIcon:()=>$i,dataTable:()=>gs,createSubMenu:()=>lo,createMenuItem:()=>ro,createMenuAction:()=>so,commandButton:()=>Y,colorInput:()=>no,codeEditor:()=>je,bringToFront:()=>Qn,bodymovinPlayer:()=>Gi,blockStyle:()=>_t,b3d:()=>Ri,availableFilters:()=>Ct,abTest:()=>Fi,XinTagList:()=>Ht,XinTag:()=>_e,XinSizer:()=>Xt,XinSelect:()=>ne,XinSegmented:()=>Bt,XinRating:()=>Pt,XinPasswordStrength:()=>It,XinNotification:()=>xn,XinMenu:()=>vt,XinLocalized:()=>R,XinForm:()=>kn,XinFloat:()=>an,XinField:()=>Ie,XinCarousel:()=>ct,TabSelector:()=>Et,SvgIcon:()=>pt,SizeBreak:()=>zt,SideNav:()=>At,RichText:()=>Dt,MarkdownViewer:()=>Tt,MapBox:()=>wn,LocalePicker:()=>ft,LiveExample:()=>Bn,FilterPart:()=>jt,FilterBuilder:()=>St,EditableRect:()=>q,DataTable:()=>xt,CodeEditor:()=>_n,BodymovinPlayer:()=>Pn,B3d:()=>mt,AbTest:()=>In});function ke(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}var nn=ke();function Sa(n){nn=n}var Ea=/[&<>"']/,Ei=new RegExp(Ea.source,"g"),Ta=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Ti=new RegExp(Ta.source,"g"),Mi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},wa=(n)=>Mi[n];function B(n,e){if(e){if(Ea.test(n))return n.replace(Ei,wa)}else if(Ta.test(n))return n.replace(Ti,wa);return n}var Ii=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Ma(n){return n.replace(Ii,(e,t)=>{if(t=t.toLowerCase(),t==="colon")return":";if(t.charAt(0)==="#")return t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1));return""})}var Pi=/(^|[^\[])\^/g;function j(n,e){n=typeof n==="string"?n:n.source,e=e||"";let t={replace:(a,o)=>{return o=o.source||o,o=o.replace(Pi,"$1"),n=n.replace(a,o),t},getRegex:()=>{return new RegExp(n,e)}};return t}var _i=/[^\w:]/g,Di=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function va(n,e,t){if(n){let a;try{a=decodeURIComponent(Ma(t)).replace(_i,"").toLowerCase()}catch(o){return null}if(a.indexOf("javascript:")===0||a.indexOf("vbscript:")===0||a.indexOf("data:")===0)return null}if(e&&!Di.test(t))t=zi(e,t);try{t=encodeURI(t).replace(/%25/g,"%")}catch(a){return null}return t}var me={},Bi=/^[^:]+:\/*[^/]*$/,Ai=/^([^:]+:)[\s\S]*$/,Oi=/^([^:]+:\/*[^/]*)[\s\S]*$/;function zi(n,e){if(!me[" "+n])if(Bi.test(n))me[" "+n]=n+"/";else me[" "+n]=ce(n,"/",!0);n=me[" "+n];let t=n.indexOf(":")===-1;if(e.substring(0,2)==="//"){if(t)return e;return n.replace(Ai,"$1")+e}else if(e.charAt(0)==="/"){if(t)return e;return n.replace(Oi,"$1")+e}else return n+e}var be={exec:function n(){}};function xa(n,e){let t=n.replace(/\|/g,(i,s,l)=>{let d=!1,h=s;while(--h>=0&&l[h]==="\\")d=!d;if(d)return"|";else return" |"}),a=t.split(/ \|/),o=0;if(!a[0].trim())a.shift();if(a.length>0&&!a[a.length-1].trim())a.pop();if(a.length>e)a.splice(e);else while(a.length<e)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(/\\\|/g,"|");return a}function ce(n,e,t){let a=n.length;if(a===0)return"";let o=0;while(o<a){let i=n.charAt(a-o-1);if(i===e&&!t)o++;else if(i!==e&&t)o++;else break}return n.slice(0,a-o)}function Vi(n,e){if(n.indexOf(e[1])===-1)return-1;let t=n.length,a=0,o=0;for(;o<t;o++)if(n[o]==="\\")o++;else if(n[o]===e[0])a++;else if(n[o]===e[1]){if(a--,a<0)return o}return-1}function Xi(n,e){if(!n||n.silent)return;if(e)console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async");if(n.sanitize||n.sanitizer)console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");if(n.highlight||n.langPrefix!=="language-")console.warn("marked(): highlight and langPrefix parameters are deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-highlight.");if(n.mangle)console.warn("marked(): mangle parameter is enabled by default, but is deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install https://www.npmjs.com/package/marked-mangle, or disable by setting `{mangle: false}`.");if(n.baseUrl)console.warn("marked(): baseUrl parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-base-url.");if(n.smartypants)console.warn("marked(): smartypants parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-smartypants.");if(n.xhtml)console.warn("marked(): xhtml parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-xhtml.");if(n.headerIds||n.headerPrefix)console.warn("marked(): headerIds and headerPrefix parameters enabled by default, but are deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install  https://www.npmjs.com/package/marked-gfm-heading-id, or disable by setting `{headerIds: false}`.")}function Ca(n,e,t,a){let o=e.href,i=e.title?B(e.title):null,s=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){a.state.inLink=!0;let l={type:"link",raw:t,href:o,title:i,text:s,tokens:a.inlineTokens(s)};return a.state.inLink=!1,l}return{type:"image",raw:t,href:o,title:i,text:B(s)}}function Hi(n,e){let t=n.match(/^(\s+)(?:```)/);if(t===null)return e;let a=t[1];return e.split(`
`).map((o)=>{let i=o.match(/^\s+/);if(i===null)return o;let[s]=i;if(s.length>=a.length)return o.slice(a.length);return o}).join(`
`)}class Kn{constructor(n){this.options=n||nn}space(n){let e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){let e=this.rules.block.code.exec(n);if(e){let t=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:!this.options.pedantic?ce(t,`
`):t}}}fences(n){let e=this.rules.block.fences.exec(n);if(e){let t=e[0],a=Hi(t,e[3]||"");return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline._escapes,"$1"):e[2],text:a}}}heading(n){let e=this.rules.block.heading.exec(n);if(e){let t=e[2].trim();if(/#$/.test(t)){let a=ce(t,"#");if(this.options.pedantic)t=a.trim();else if(!a||/ $/.test(a))t=a.trim()}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(n){let e=this.rules.block.hr.exec(n);if(e)return{type:"hr",raw:e[0]}}blockquote(n){let e=this.rules.block.blockquote.exec(n);if(e){let t=e[0].replace(/^ *>[ \t]?/gm,""),a=this.lexer.state.top;this.lexer.state.top=!0;let o=this.lexer.blockTokens(t);return this.lexer.state.top=a,{type:"blockquote",raw:e[0],tokens:o,text:t}}}list(n){let e=this.rules.block.list.exec(n);if(e){let t,a,o,i,s,l,d,h,m,p,u,E,T=e[1].trim(),V=T.length>1,S={type:"list",raw:"",ordered:V,start:V?+T.slice(0,-1):"",loose:!1,items:[]};if(T=V?`\\d{1,9}\\${T.slice(-1)}`:`\\${T}`,this.options.pedantic)T=V?T:"[*+-]";let x=new RegExp(`^( {0,3}${T})((?:[	 ][^\\n]*)?(?:\\n|$))`);while(n){if(E=!1,!(e=x.exec(n)))break;if(this.rules.block.hr.test(n))break;if(t=e[0],n=n.substring(t.length),h=e[2].split(`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];$n("demo-style",Io);var sn="tosijs";setTimeout(()=>{let n=v.fromVar(r.brandColor),e=v.fromVar(r.background);console.log(`welcome to %c${sn}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var yl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",gl=De.find((n)=>n.filename===yl)||De[0],{app:A,prefs:N}=Jn({app:{title:sn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${sn}#readme`,npmUrl:`https://www.npmjs.com/package/${sn}`,xinjsuiUrl:"https://ui.xinjs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${sn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${sn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${sn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${sn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:De,currentDoc:gl},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});Ue((n)=>{if(n.startsWith("prefs"))return!0;return!1});U.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};U.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:A,tosi:Jn,img:Oe,bindings:U,elements:g,vars:r,touch:un,Color:v})},1000);var Po=document.querySelector("main"),{h2:fl,div:_o,span:Be,a:Ae,img:Oe,header:wl,button:Do,template:vl,input:xl}=g;H(document.body,"prefs.theme",{toDOM(n,e){if(e==="system")e=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",e==="dark")}});H(document.body,"prefs.highContrast",{toDOM(n,e){n.classList.toggle("high-contrast",e)}});H(document.body,"prefs.monochrome",{toDOM(n,e){n.classList.toggle("monochrome",e)}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);A.currentDoc=A.docs.find((e)=>e.filename===n)||A.docs[0]});var Cl=re(()=>{console.time("filter");let n=Bo.value.toLocaleLowerCase();A.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),un(A.docs),console.timeEnd("filter")}),Bo=xl({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Cl});if(Po)Po.append(wl(Ae({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`xinjs ${he}, xinjs-ui ${Nt}`},Oe({src:"favicon.svg",style:{height:40,marginRight:10}}),fl({bindText:"app.title"})),Be({class:"elastic"}),Vt({minWidth:750},Be({style:{marginRight:r.spacing,display:"flex",alignItems:"center",gap:r.spacing50}},Ae({href:A.bundleUrl},Oe({alt:"bundlejs size badge",src:A.bundleBadgeUrl})),Ae({href:A.cdnUrl},Oe({alt:"jsdelivr",src:A.cdnBadgeUrl}))),Be({slot:"small"})),Be({style:{flex:"0 0 10px"}}),Do({title:"theme",class:"iconic",onClick(n){Z({target:n.target,menuItems:[{icon:"github",caption:"github",action:A.githubUrl},{icon:"npm",caption:"npm",action:A.npmUrl},{icon:"discord",caption:"discord",action:A.discordUrl},{icon:"xinjsUiColor",caption:"xinjs-ui",action:A.xinjsuiUrl},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return N.theme==="system"},action(){N.theme="system"}},{caption:"Dark",checked(){return N.theme==="dark"},action(){N.theme="dark"}},{caption:"Light",checked(){return N.theme==="light"},action(){N.theme="light"}},null,{caption:"High Contrast",checked(){return N.highContrast},action(){N.highContrast=!N.highContrast}},{caption:"Monochrome",checked(){return N.monochrome},action(){N.monochrome=!N.monochrome}}]}]})}},f.moreVertical())),Ot({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"}},Bo,_o({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:A.docs}},vl(Ae({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=pn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=e;window.history.pushState({href:o},"",o),A.currentDoc=t,n.preventDefault()}}))),_o({style:{position:"relative",overflowY:"scroll",height:"100%"}},Do({title:"show navigation",class:"transparent close-nav show-within-compact",style:{marginTop:"2px",position:"fixed"},onClick(n){n.target.closest("xin-sidenav").contentVisible=!1}},f.chevronLeft()),Mt({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Bn.insertExamples(this,{xinjs:Rn,xinjsui:Wt})}}))));

//# debugId=00A6FD836170FA1564756E2164756E21
