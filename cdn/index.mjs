...
export { Color, Component, bind, bindings, css, elements, filter, getListItem, hotReload, initVars, makeComponent, makeWebComponent, matchType, observe, observerShouldBeRemoved, on, settings, touch, typeSafe, unobserve, useXin, vars, xin, xinPath, xinValue };
