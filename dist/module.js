    ...
    for (const key of Object.keys(elementProps)){
        ...
        if (key === "apply") value(elt);
            ...
            if (typeof value === "object") for (const prop of Object.keys(value)){
                const processed = (0, $49cee7f7f866c751$export$4f8a9e649bc1f08b)((0, $bed4bed3dcfb6f9a$export$87ae551bf60f4bb)(prop), value[prop]);
            ...
            if (binding !== undefined && value.value !== undefined) (0, $b5796eaeba5c782e$export$2385a24977818dd0)(elt, value.value, value.binding instanceof Function ? {
                toDOM: value.binding
            } : value.binding);
...
function $cf96335958b9d6da$export$3bc26eec1cc2439f(tag, blueprint) {
    const { type: type, styleSpec: styleSpec } = blueprint(tag, {
        ...
        svgElements: $9e0c0b8784c80412$export$cf20112a1bc148da,
        mathML: $9e0c0b8784c80412$export$8ec252cfdd664597,
        varDefault: $49cee7f7f866c751$export$75c0e6adb3e38f31,
        vars: $49cee7f7f866c751$export$3cb96c9f6c8d16a4,
        xinProxy: $7bb234cc8fd49201$export$95a552d2395ab4c4
    });
    return {
        type: type,
