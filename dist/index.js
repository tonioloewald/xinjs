...
class BlueprintLoader extends (0, $l4YkF.Component) {
    ...
    async load() {
        ...
        const { creator } = (0, $9C2PN.makeComponent)(tag, blueprint);
...
class $0ea0392c3fe8c9d5$export$16fa2f45be04daa8 extends HTMLElement {
    ...
    constructor(){
        super();
        this.content = (0, $avKYm.elements).slot();
...
const $b3e4d800ba46b430$var$regHandler = (path, boxScalars)=>({
        ...
        // as you'd expect
        get (target, _prop) {
            if (_prop === (0, $bRLVT.XIN_PATH)) return path;
            else if (_prop === (0, $bRLVT.XIN_VALUE)) {
                while((0, $bRLVT.xinPath)(target) !== undefined)target = (0, $bRLVT.xinValue)(target);
                return target;
            }
...
const $5c922f2f7914f4ef$export$97a1a3e6f39778d2 = {
    value: {
        toDOM (element, value) {
            (0, $hSIZW.setValue)(element, value);
        },
        fromDOM (element) {
...
function $b43c5f28217f2268$export$95a552d2395ab4c4(obj, boxScalars = false) {
    ...
    Object.keys(obj).forEach((key)=>{
        ...
        registered[key] = boxScalars ? (0, $ev5U7.boxed)[key] : (0, $ev5U7.xin)[key];
    });
    return registered;
}
