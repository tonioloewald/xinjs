...
const $a20b878345862077$var$create = (tagType, ...contents)=>{
    ...
    for (const key of Object.keys(elementProps)){
        ...
        if (key === "apply") value(elt);
            ...
            if (binding !== undefined && value.value !== undefined) (0, $5258c5e951c26004$export$2385a24977818dd0)(elt, value.value, value.binding);
    ...
    static elementCreator(options = {}) {
        if (this._elementCreator == null) {
            ...
            if (styleSpec !== undefined) {
                let cssSource = (0, $5ce3d7bba914ef8e$export$dbf350e5966cf602)(styleSpec);
                if (tag !== undefined && tagName !== tag) cssSource = cssSource.replace(new RegExp(`\\b${tag}\\b`, "g"), tagName);
                document.head.append((0, $a20b878345862077$export$7a5d735b2ab6389d).style({
                    id: tagName
                }, cssSource));
            }
        }
...
class $c8d63d32a2a98788$export$e8658328209d5943 extends (0, $0ea0392c3fe8c9d5$export$16fa2f45be04daa8) {
    ...
    constructor(){
        ...
        this.statis = "";
        this.expect = true;
        this.styleNode = (0, $0ea0392c3fe8c9d5$export$16fa2f45be04daa8).StyleNode({
            ":host": {
                display: "flex",
                gap: "5px",
                alignItems: "center"
