...
const $a20b878345862077$export$7a5d735b2ab6389d = new Proxy({
    ...
    get (target, tagName) {
        ...
        target[tagName] = (...contents)=>$a20b878345862077$export$185802fd694ee1f5(tagName, ...contents);
        // @ts-expect-error
