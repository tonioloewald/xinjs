...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
| `tosijs`                | everything, agent surface included — bundlers shake what you don't import                                                | <!--gz:module.js-->~44 kB<!--/gz--> |
...
- **Zero runtime dependencies.**
  ...
  <!--agentgz-->~17.5 kB<!--/agentgz--> of the full ESM entry — exactly what
